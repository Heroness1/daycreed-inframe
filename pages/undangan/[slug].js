...
export default function UndanganKlien() {
  ...
  const calculateTimeLeft = () => {
    const difference =
      +new Date('2026-10-09T10:00:00+07:00') - +new Date();
  ...
  const namaTamu = router.query.kpd
    ? decodeURIComponent(router.query.kpd)
    : 'Tamu Undangan';
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Undangan pernikahan ${namaMempelai}`}
        />
      ...
      <div className="w-full min-h-screen bg-[#11110f] flex justify-center font-[DM_Sans,sans-serif] text-[#292720] selection:bg-[#ad8b54] selection:text-white">
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1659095141570-be8b9aff59ce?auto=format&fit=crop&q=85&w=1200"
                  alt="Wedding"
                  className="cover-image absolute inset-0 h-full w-full object-cover"
                />
                    ...
                    {namaMempelai
                      ...
                      .map((name, index) => (
                        ...
                        >
                          {name}
                          {index === 0 && (
                            <span className="block my-2 text-xl font-normal italic text-white/70">
                              &
                            </span>
                          )}
                        </span>
          ...
          {isOpen && (
            <div className="relative pb-28">
              ...
              <section
                id="home"
                data-section
                className="relative flex min-h-[100dvh] flex-col justify-center overflow-hidden px-8 py-20 text-center"
              >
                ...
                <div className="reveal mx-auto max-w-[390px]">
                    ...
                    {namaMempelai
                      ...
                      .map((name, index) => (
                        ...
                        >
                          ...
                          {index === 0 && (
                            <span className="my-3 block text-xl font-normal italic text-[#b39462]">
                              &
                            </span>
                          )}
                        </span>
                  ...
                  <p className="mx-auto mt-8 max-w-[270px] text-[11px] leading-6 tracking-wide text-[#77736b]">
                    ...
                    Anda untuk menjadi bagian dari hari istimewa
                    kami.
                  </p>
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
                  <div className="flex flex-col items-center gap-2 text-[#a78a5a]">
                    <span className="text-[8px] uppercase tracking-[0.3em]">
                      Scroll
                    </span>
                    <span className="h-8 w-px bg-[#b79a69]/60 animate-pulse" />
                  </div>
                </div>
              ...
              <section
                className="relative bg-[#20201c] px-9 py-28 text-center text-[#f4efe5]"
              >
                <div className="mx-auto max-w-[350px]">

                  <span className="font-[Playfair_Display,serif] text-4xl text-[#b79a69]">
                    “
                  </span>
                  ...
                  <p className="mt-4 text-[9px] uppercase tracking-[0.3em] text-white/50">
                    Ar-Rum : 21
                  </p>
              ...
              <section
                id="couple"
                data-section
                className="px-7 py-28 text-center"
              >
                ...
                <div className="mx-auto mt-12 max-w-[360px]">
                  ...
                  <div className="relative mx-auto w-[190px]">
                    ...
                    <img
                      src="https://images.unsplash.com/photo-1659095141570-be8b9aff59ce?auto=format&fit=crop&w=700&q=85"
                      alt="Bride"
                  ...
                  <p className="mt-2 text-[10px] uppercase tracking-[0.15em] text-[#77736b]">
                    Putri Bapak H. Fulan & Ibu Hj. Fulanah
                  </p>

                  <div className="my-9 font-[Playfair_Display,serif] text-2xl italic text-[#b39462]">
                    &
                  </div>
              ...
              <section
                id="event"
                data-section
                className="bg-[#eeeadf] px-6 py-28 text-center"
              >
                ...
                <p className="mx-auto mt-5 max-w-[280px] text-[11px] leading-6 text-[#77736b]">
                  Sampai tiba waktunya kami mengucapkan
                  janji dalam sebuah hari yang istimewa.
                </p>
                ...
                <div className="mx-auto max-w-[390px]">
                  ...
                  <div className="mt-12">
                    ...
                    <div className="mb-12">
                      ...
                      <p className="text-[9px] uppercase tracking-[0.25em] text-[#a07f4d]">
                        The Beginning
                      </p>

                      <p className="mt-4 text-xs leading-7 text-[#77736b]">
                        Sebuah pertemuan sederhana yang
                        perlahan tumbuh menjadi cerita yang
                        ingin kami bawa sepanjang perjalanan
                        hidup.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-4 font-[Playfair_Display,serif] text-2xl leading-9 italic text-[#4e4a42]">
              ...
              <section
                id="gallery"
                data-section
                className="bg-[#20201c] px-5 py-28 text-[#f5f0e7]"
              >

                <div className="px-3 text-center">

                  <p className="text-[9px] uppercase tracking-[0.4em] text-[#b99a67]">
                    MOMENTS
                  </p>

                  <h3 className="mt-4 font-[Playfair_Display,serif] text-4xl italic">
                    Our Gallery
                  </h3>

                  <p className="mx-auto mt-5 max-w-[270px] text-[10px] leading-6 text-white/45">
              ...
              >
                ...
                <div className="mx-auto max-w-[390px]">
                  ...
                  <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[280px] text-[11px] leading-6 text-[#77736b]">
                      Kehadiran Anda akan menjadi bagian
                      berharga dari hari istimewa kami.
                    </p>
                  ...
                  {!submitted ? (
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="group mt-4 flex w-full items-center justify-center gap-4 border border-[#806338] py-4 text-[9px] font-medium uppercase tracking-[0.3em] text-[#806338] transition-all duration-500 hover:bg-[#806338] hover:text-white"
                      >
                        Send Wishes
                    ...
                    <div className="mt-12 border-y border-[#b39462]/30 py-14 text-center animate-[fadeUp_.7s_ease-out]">
                      ...
                      <h4 className="mt-7 font-[Playfair_Display,serif] text-3xl italic text-[#8c6d3e]">
                        Thank You
                      </h4>

                      <p className="mx-auto mt-5 max-w-[260px] text-xs leading-6 text-[#77736b]">
                        Ucapan dan doa baik Anda sangat
                        berarti bagi kami.
                      </p>
                ...
                <div className="mx-auto mt-28 max-w-[390px] border-t border-[#b39462]/25 pt-20 text-center">
                  ...
                  <p className="mx-auto mt-5 max-w-[280px] text-[11px] leading-6 text-[#77736b]">
                    Bagi Anda yang ingin memberikan tanda
                    kasih, kami menyediakan pilihan hadiah
                    digital.
                  </p>

                  <button
                    onClick={() => setShowGift(!showGift)}
                    className="mt-8 border border-[#806338] px-7 py-3 text-[9px] uppercase tracking-[0.28em] text-[#806338] transition-all duration-500 hover:bg-[#806338] hover:text-white"
                  >
                    {showGift
                      ? 'Close Details'
                      : 'View Gift Details'}
                    ...
                    <div className="overflow-hidden">
                      ...
                      <div className="border border-[#b39462]/30 bg-[#eeeadf] px-6 py-9">
                        ...
                        <button
                          ...
                          className="mt-7 inline-flex items-center gap-3 border border-[#806338] px-5 py-3 text-[9px] uppercase tracking-[0.2em] text-[#806338]"
                        >
              ...
              <section className="relative overflow-hidden bg-[#171714] px-8 py-32 text-center text-[#f5f0e7]">
                ...
                <div className="absolute inset-0 opacity-20">
                  <img
                    src="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=1200&q=70"
                    alt=""
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="mt-6 font-[Playfair_Display,serif] text-5xl italic">
                    Thank You
                  </h3>
                  ...
                  <p className="mt-3 text-[8px] uppercase tracking-[0.35em] text-white/35">
                    09 · 10 · 2026
                  </p>
          ...
          {selectedImage && (
            <div
              className="fixed inset-0 z-[200] flex items-center justify-center bg-black/95 p-5 animate-[fadeIn_.3s_ease-out]"
              onClick={() => setSelectedImage(null)}
            >

              <button
                onClick={() => setSelectedImage(null)}
                className="absolute right-5 top-5 z-10 flex h-10 w-10 items-center justify-center border border-white/30 text-white"
              ...
              <img
                ...
                className="max-h-[85vh] max-w-full object-contain animate-[scaleIn_.5s_ease-out]"
                onClick={(event) =>
            ...
            <nav className="fixed bottom-4 left-1/2 z-[90] flex w-[calc(100%-32px)] max-w-[450px] -translate-x-1/2 items-center justify-around border border-[#c9bda8]/40 bg-[#f7f4ee]/90 px-3 py-2 shadow-[0_10px_40px_rgba(0,0,0,.12)] backdrop-blur-xl">
              ...
              {[
                ...
                <button
                  ...
                  className={`relative flex min-w-[62px] flex-col items-center gap-1.5 px-3 py-2 transition-colors duration-300 ${
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 h-px bg-[#a78652] transition-all duration-500 ${
                      activeSection === item.id
                        ? 'w-5'
                        : 'w-0'
                    }`}
          ...
          <style jsx global>{`
            ...
            * {
            ...
            .cover-image {
              animation: coverZoom 12s ease-out forwards;
            }
            ...
            .reveal-image {
              animation: imageReveal 1.4s cubic-bezier(.22,1,.36,1) both;
            }
