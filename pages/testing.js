...
const dataLayanan = [
  {
    ...
    deskripsi: "Melayani berbagai kebutuhan cetak untuk keperluan bisnis, akademik, maupun sehari-hari.",
    gambar: "/digitalprinting.jpeg"
  },
  {
    judul: "Cetak Beragam Media",
    deskripsi: "Pilihan untuk berbagai kebutuhan cetak dengan media dan ukuran yang beragam.",
    gambar: "/eyecolor.jpeg"
  },
  {
    judul: "Banner & Spanduk",
    deskripsi: "Untuk kebutuhan promosi, informasi, acara, dan berbagai keperluan lainnya.",
    gambar: "/lempanas.jpeg"
  },
  {
    judul: "Kebutuhan Percetakan",
    deskripsi: "Kami melayani berbagai kebutuhan percetakan sesuai kebutuhan pelanggan.",
    gambar: "/owner.jpeg"
  }
];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:description" content="Digital printing 24 jam di Jakarta Timur. Hardcover skripsi, banner, stiker, brosur, dan berbagai kebutuhan cetak." />
      ...
      <main className="bg-white text-black font-sans">
        ...
        <header className="fixed top-0 left-0 right-0 w-full bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm z-50">
          <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-bold text-2xl tracking-tight">Subur Maju Printing</div>
            ...
            <nav aria-label="Navigasi utama" className="hidden md:flex items-center gap-8 text-sm font-medium">
              ...
              <a href="#katalog" className="text-gray-800 hover:text-orange-600 transition">Katalog</a>
        ...
        <section aria-labelledby="hero-title" className="pt-24 min-h-screen bg-gradient-to-br from-orange-600 via-amber-600 to-red-600 flex items-center">
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center py-20">
            ...
            <div className="text-white">
              ...
              <h1 id="hero-title" className="text-6xl md:text-7xl font-bold leading-none tracking-tighter mb-6">
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                ...
                <a href="#katalog" className="border border-white/70 hover:bg-white/10 font-semibold px-8 py-4 rounded-2xl text-lg transition">
                  Lihat Katalog
                </a>
              </div>
            </div>
        ...
        <section id="lokasi" aria-labelledby="lokasi-title" className="bg-white py-24 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 id="lokasi-title" className="text-center text-4xl font-bold mb-12">Lokasi Kami</h2>
        ...
        <section aria-labelledby="cta-title" className="py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto text-center">
            <h2 id="cta-title" className="text-5xl font-bold">Siap Cetak Sekarang?</h2>
            <p className="mt-4 text-xl text-gray-500">Kirim file Anda dan konsultasikan kebutuhan cetak melalui WhatsApp.</p>
            <a
