      ...
      <main className="bg-slate-950 text-slate-300 font-sans selection:bg-orange-500/30 selection:text-white">
        ...
        >
          <div className="flex items-center justify-between px-5 h-16">
            ...
            <nav
              ...
              className="flex items-center gap-1 md:gap-2 text-[13px] font-medium text-slate-400"
            >
              <a
                href="#layanan"
                className="px-4 py-2 rounded-full hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300"
              >
                Layanan
              </a>
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            {/* Overlay dibuat lebih netral agar orange tidak mendominasi */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
              ...
              {dataKenapaKami.map((item, index) => (
                <article
                  key={index}
                  className="group relative bg-slate-950/70 backdrop-blur-sm rounded-3xl rounded-br-[80px] p-8 lg:p-10 border border-slate-800 hover:border-orange-500/40 hover:bg-slate-950 shadow-lg shadow-black/20 hover:shadow-[0_8px_30px_rgba(234,88,12,0.08)] transition-all duration-500 overflow-hidden"
                >
        ...
        >
          <div className="max-w-7xl mx-auto px-6 text-center mb-10">
            ...
            <p
              id="klien-title"
              className="text-xs md:text-sm font-bold tracking-widest text-orange-500/80 uppercase"
            >
              ...
              {[...dataKlien, ...dataKlien, ...dataKlien].map(
                (klien, index) => (
                  <div
                    ...
                    className="flex flex-col items-center justify-center gap-3 px-6 group"
                  >
        ...
        <section
          ...
          className="py-24 px-6 bg-slate-900 relative"
        >
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 max-w-2xl mx-auto text-lg">
                Kunjungi toko kami atau hubungi secara online. Kami siap
                melayani kebutuhan cetak Anda kapan saja.
              </p>
              ...
              <article className="bg-slate-950/80 backdrop-blur-md rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-slate-800 transition-all duration-300 hover:-translate-y-2 hover:border-orange-500/40 hover:shadow-[0_8px_40px_rgba(234,88,12,0.12)]">
                ...
                <div className="mt-8 pt-8 border-t border-slate-800">
                  ...
                  <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                    Spesialis percetakan Jakarta Timur. Melayani{" "}
                    <strong className="text-slate-300 font-medium">
                      hardcover skripsi, digital printing, banner, stiker, dan
                      brosur
                    </strong>{" "}
            ...
            <div className="relative bg-gradient-to-b from-slate-900 to-slate-950 rounded-[3rem] px-8 py-20 overflow-hidden shadow-2xl border border-slate-800 flex flex-col items-center text-center">
              ...
              <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <p className="mt-4 text-lg md:text-xl text-slate-400 mb-10 leading-relaxed">
                  Tidak perlu repot datang ke toko. Kirim file Anda dan
                  konsultasikan kebutuhan cetak langsung melalui WhatsApp.
                </p>
              ...
              <div className="md:col-span-5 lg:col-span-4">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <img
                    src="/avatar.png"
                    alt="Logo Subur Maju Printing"
                    className="w-14 h-14 rounded-2xl object-cover ring-2 ring-orange-500/20 shadow-xl shadow-black/30"
                  />
                ...
                <p className="text-slate-400 text-sm leading-relaxed mb-8 pr-4">
                  Spesialis percetakan modern di Jakarta Timur. Melayani
                  kebutuhan akademik, bisnis, dan personal dengan teknologi
                  cetak terbaru, pengerjaan kilat, dan hasil premium.
                </p>
                ...
                <ul className="space-y-5">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <address className="not-italic text-slate-400 text-sm leading-relaxed">
                      ...
                      <strong className="text-slate-200 font-medium block mb-1">
                        Workshop Rawamangun
                      </strong>
                  ...
                  <li className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <strong className="text-slate-200 font-medium block text-sm mb-0.5">
                        WhatsApp / Telepon
                      </strong>
              ...
              <div className="md:col-span-3 lg:col-span-4">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-4 text-sm text-slate-400">
                  ...
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-2.5 group cursor-pointer hover:text-orange-400 transition-colors"
                    >
          ...
          <div className="border-t border-slate-800 bg-slate-950/50">
            ...
            <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
              ...
              <p className="flex items-center gap-1.5 tracking-wide">
                Digital Presence by{" "}
                <span className="font-semibold text-orange-400 ml-1 hover:text-orange-300 transition-colors cursor-pointer">
                  LURE
                </span>
              </p>
        ...
        >
          ...
          <span
            aria-hidden="true"
            className="absolute inset-0 rounded-2xl border-4 border-orange-400/80 animate-ping opacity-75"
          />
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setIsSmartOrderOpen(false)}
              className="absolute -top-12 right-0 md:-right-12 text-slate-400 hover:text-orange-400 transition-colors"
