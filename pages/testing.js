  ...
  return (
    <>
      ...
      <main className="bg-slate-950 text-orange-100/80 font-sans selection:bg-orange-500/30 selection:text-orange-100">
        ...
        {/* ================= NAVBAR ================= */}
        <header 
          className={`fixed ${showNavbar ? 'top-4' : '-top-24'} transition-all duration-500 ease-in-out left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-[800px] bg-slate-900/60 backdrop-blur-2xl backdrop-saturate-200 border border-orange-500/20 shadow-2xl shadow-black/50 z-50 rounded-full`}
        >
          <div className="flex items-center justify-between px-5 h-16">
            <div className="flex items-center gap-3">
              <img src="/avatar.png" alt="Logo Subur Maju Printing" className="w-10 h-10 rounded-full object-cover border border-orange-500/30" />
            ...
            <nav aria-label="Navigasi utama" className="flex items-center gap-1 md:gap-2 text-[13px] font-medium text-orange-200/70">
              <a href="#layanan" className="px-4 py-2 rounded-full hover:bg-orange-500/10 hover:text-orange-300 transition-all duration-300">Layanan</a>
              <a href="#katalog" className="px-4 py-2 rounded-full hover:bg-orange-500/10 hover:text-orange-300 transition-all duration-300">Katalog</a>
              <a href="#lokasi" className="px-4 py-2 rounded-full hover:bg-orange-500/10 hover:text-orange-300 transition-all duration-300">Lokasi</a>
            </nav>
          </div>
        </header>
        ...
        >
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-slate-950/90 via-slate-900/60 to-orange-950/50 backdrop-contrast-125"></div>
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
            <div className="text-white max-w-3xl">
              ...
              >
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-200">Hardcover Skripsi & Percetakan</span>
              </h1>

              <p className="text-lg md:text-xl text-orange-100/70 max-w-xl mb-10 leading-relaxed drop-shadow-sm">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="#katalog"
                  className="border border-orange-500/30 bg-slate-900/40 hover:bg-orange-500/10 font-semibold px-8 py-4 rounded-2xl text-lg transition-all duration-300 text-orange-100 backdrop-blur-sm"
                >
                  Lihat Katalog
                </a>
              </div>
        ...
        <section id="layanan" aria-labelledby="layanan-title" className="py-24 px-6 bg-slate-900 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-orange-600 to-amber-400 mx-auto rounded-full mb-6"></div>
              <p className="text-orange-200/60 max-w-2xl mx-auto text-[17px] font-medium leading-relaxed tracking-tight">
            ...
            <div className="flex gap-6 lg:gap-8 overflow-x-auto snap-x snap-mandatory pb-10 pt-4 scrollbar-hide px-4 -mx-4 md:px-0 md:mx-0">
              {dataLayanan.map((item, index) => (
                <article 
                  key={index} 
                  className="group min-w-[85%] sm:min-w-[60%] lg:min-w-[31.333%] snap-center bg-slate-950/50 backdrop-blur-sm rounded-[2rem] border border-orange-900/30 hover:border-orange-500/50 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(234,88,12,0.15)] transition-all duration-500 flex flex-col overflow-hidden"
                >
                  ...
                  <div className="p-8 lg:p-10 flex flex-col flex-grow relative bg-transparent z-10 -mt-10">
                    <h3 className="font-bold text-2xl mb-3 text-orange-50 group-hover:text-orange-400 transition-colors duration-300 tracking-tight drop-shadow-md">
                      {item.judul}
                    </h3>
                    <p className="text-orange-200/60 leading-relaxed font-medium mb-8 flex-grow">
                      {item.deskripsi}
                    </p>
        ...
        {/* ================= WHY US ================= */}
        <section id="kenapa-kami" aria-labelledby="kenapa-title" className="py-24 px-6 bg-slate-900 border-y border-orange-900/20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 id="kenapa-title" className="text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-4">
                Kenapa pilih kami?
              </h2>
              <div className="w-20 h-1 bg-gradient-to-r from-orange-600 to-amber-400 mx-auto rounded-full"></div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
              {dataKenapaKami.map((item, index) => (
                <article 
                  key={index} 
                  className="group relative bg-slate-950/60 backdrop-blur-sm rounded-3xl rounded-br-[80px] p-8 lg:p-10 border border-orange-900/30 hover:border-orange-500/40 hover:bg-slate-900 shadow-lg shadow-black/20 hover:shadow-[0_8px_30px_rgba(234,88,12,0.08)] transition-all duration-500 overflow-hidden"
                >
                  <div className="absolute -top-10 -right-10 w-40 h-40 bg-orange-500/0 rounded-full blur-3xl group-hover:bg-orange-500/10 transition-colors duration-500 pointer-events-none"></div>

                  <div className="absolute top-8 right-8 text-orange-900/50 group-hover:text-orange-400 group-hover:rotate-180 transition-all duration-700">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 5v14M5 12h14" />
                    </svg>
                  </div>

                  <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-0 bg-gradient-to-b from-orange-500 to-amber-400 rounded-r-full group-hover:h-1/2 transition-all duration-500"></div>

                  <div className="relative z-10">
                    <h3 className="font-bold text-2xl mb-4 text-orange-50 group-hover:text-orange-400 transition-colors duration-300 pr-8">
                      {item.judul}
                    </h3>
            ...
            <div className="inline-flex animate-marquee items-center gap-16">
              {[...dataKlien, ...dataKlien, ...dataKlien].map((klien, index) => (
                <div key={`${klien.nama}-${index}`} className="flex flex-col items-center justify-center gap-3 px-6 group">
                  ...
                  <span className="text-xs md:text-sm font-medium text-orange-200/40 group-hover:text-orange-200/80 transition-colors text-center whitespace-nowrap">{klien.nama}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <h2 id="lokasi-title" className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
                Temukan <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-300">Lokasi Kami</span>
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <article className="bg-slate-950/80 backdrop-blur-md rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-orange-900/30 transition-all duration-300 hover:-translate-y-2 hover:border-orange-500/40 hover:shadow-[0_8px_40px_rgba(234,88,12,0.12)]">
                ...
                <ul className="space-y-6">
                  <li className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-orange-50 mb-1">Alamat Toko</h4>
                      <address className="not-italic text-orange-200/60 leading-relaxed text-sm">
                  ...
                  <li className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-orange-50 mb-1">WhatsApp / Telepon</h4>
                      <p className="text-orange-200/60 text-sm">0822-4692-6544</p>
                    </div>
                  </li>
                </ul>

                <div className="mt-8 pt-8 border-t border-orange-900/30">
                  <p className="text-orange-200/50 text-sm mb-6 leading-relaxed">
                    Spesialis percetakan Jakarta Timur. Melayani <strong className="text-orange-300 font-medium">hardcover skripsi, digital printing, banner, stiker, dan brosur</strong> dengan kualitas premium.
                  </p>
                  <a
              ...
              <div className="relative group h-full min-h-[400px]">
                <div className="absolute -inset-3 bg-gradient-to-tr from-orange-600 to-amber-400 rounded-[3rem] blur-2xl opacity-10 group-hover:opacity-25 transition duration-500"></div>
                <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] shadow-2xl ring-1 ring-orange-900/50 bg-slate-900">
                  <iframe
        ...
        >
          ...
          >
            <button 
              onClick={() => setIsSmartOrderOpen(false)}
              className="absolute -top-12 right-0 md:-right-12 text-orange-200/50 hover:text-orange-400 transition-colors"
